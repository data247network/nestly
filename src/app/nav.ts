...
export const NAV_GROUPS: { name: string; surface: Surface; items: ScreenId[] }[] = [
  ...
  { name: 'Child Device', surface: 'child', items: ['childHome', 'childRoutines', 'childRequests', 'childRequestHistory', 'childRewards', 'childChores', 'childHub', 'childLock', 'childNotice'] },
...
export const LABELS: Record<ScreenId, string> = {
  ...
  v2control: 'Control centre', home: 'Control centre', schoolModeV2: 'School Mode', choresV2: 'Tasks & Rewards', map: 'Map & safe zones', geofence: 'New safe zone', screentime: 'Screen time', scenario: 'School mode & routines', activity: 'Web & apps', trail: 'Activity trail', contacts: 'Emergency contacts', alerts: 'Alerts', acoustic: 'Acoustic alert', hub: 'Family hub', tips: 'Safety tips',
  childHome: 'Child home', childRoutines: 'My routines', childRequests: 'My requests', childRequestHistory: 'My past requests', childRewards: 'My rewards', childChores: 'My Tasks', childHub: 'Message hub', childLock: 'Lock screen', childNotice: 'Transparency notice', webOverview: 'Overview', webSplit: 'Map & activity', paywall: 'Plans & billing',
}
...
export const CHILD_SCREENS: ScreenId[] = ['childHome', 'childRoutines', 'childRequests', 'childRequestHistory', 'childRewards', 'childChores', 'childHub', 'childLock', 'childNotice']
