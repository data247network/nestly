...
export const NAV_GROUPS: { name: string; surface: Surface; items: ScreenId[] }[] = [
  ...
  { name: 'Parent App', surface: 'parent', items: ['v2control', 'schoolModeV2', 'home', 'map', 'screentime', 'scenario', 'activity', 'trail', 'contacts', 'alerts', 'hub', 'report'] },
...
export const LABELS: Record<ScreenId, string> = {
  ...
  v2control: 'Control centre', schoolModeV2: 'School Mode', home: 'Home', map: 'Map & safe zones', geofence: 'New safe zone', screentime: 'Screen time', scenario: 'School mode & routines', activity: 'Web & apps', trail: 'Activity trail', contacts: 'Emergency contacts', alerts: 'Alerts', acoustic: 'Acoustic alert', hub: 'Family hub', tips: 'Safety tips',
