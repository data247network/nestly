...
export const NAV_GROUPS: { name: string; surface: Surface; items: ScreenId[] }[] = [
  ...
  { name: 'Child Device', surface: 'child', items: ['childHome', 'childRoutines', 'childRequests', 'childRewards', 'childChores', 'childHub', 'childLock', 'childNotice'] },
...
export const LABELS: Record<ScreenId, string> = {
  ...
  childHome: 'Child home', childRoutines: 'My routines', childRequests: 'My requests', childRewards: 'My rewards', childChores: 'My chores', childHub: 'Message hub', childLock: 'Lock screen', childNotice: 'Transparency notice', webOverview: 'Overview', webSplit: 'Map & activity', paywall: 'Plans & billing',
}
...
export const CHILD_SCREENS: ScreenId[] = ['childHome', 'childRoutines', 'childRequests', 'childRewards', 'childChores', 'childHub', 'childLock', 'childNotice']
